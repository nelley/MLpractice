...
is_setosa = (labels == 'setosa')    #create setosa boolean array
features = features[~is_setosa]     #create width/length value array without setosa
labels = labels[~is_setosa]         #create name value array without setosa
is_virginica = (labels == 'virginica')  #create virginica boolean array 
